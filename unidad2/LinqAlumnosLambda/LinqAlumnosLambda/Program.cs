...
namespace LinqAlumnosLambda
{
    class Program
    {
        ...
        {
            var alumnas = listaalumnos.Where(p => p.sexo == "F");
...

        {
            ...
            var ordenarnombre = listaalumnos.OrderBy(l => l.nombre);
        ...
        public static void Mayores20(Alumno[] listaalumnos)
        {
            ...
            var mayores20 = listaalumnos.Where(a => a.edad > 20);
        ...
        public static void SexoPrimerApellido(Alumno[] listaalumnos)
        {
            ...
            var SexoApellido = listaalumnos.OrderBy(p => p.sexo).ThenByDescending(p => p.primerapellido);
        ...
        public static void AgruparEdad(Alumno[] listaalumnos)
        {
            ...
            var Edad = listaalumnos.GroupBy(p => p.edad);
        ...
        public static void CantidadEdad(Alumno[] listaalumnos)
        {
            ...
            var cantidad = listaalumnos.GroupBy(t => new { Edad = t.edad })
                         .Select(g => new {
                             Cantidad = g.Count(),
                             Edad = g.Key.Edad
                         });
